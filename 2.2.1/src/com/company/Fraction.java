...
// знаменатель всегда положительный
    ...
    public static Fraction DifferFraction(Fraction obj1, Fraction obj2){
        return new Fraction(obj1.numerator * obj2.denominator - obj2.numerator * obj1.denominator, obj1.denominator * obj2.denominator);
    }
    public static Fraction increaseFraction(Fraction obj1, Fraction obj2){
        return new Fraction(obj1.numerator * obj2.numerator , obj1.denominator * obj2.denominator);
    }
    public static Fraction divisionFraction(Fraction obj1, Fraction obj2){
